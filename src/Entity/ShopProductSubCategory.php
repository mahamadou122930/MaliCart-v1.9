...
class ShopProductSubCategory
{
    ...
    #[ORM\ManyToMany(targetEntity: ShopProductCategory::class, mappedBy: 'SubCategory', cascade: ["persist", "remove"])]
    private Collection $shopProductCategories;

    #[ORM\OneToMany(mappedBy: 'SubCategory', targetEntity: ShopProduct::class, cascade: ["persist", "remove"])]
